...
const addHandler = async (e) => {
  ...
  return (
    ...
    <br />
  <TextField variant='outlined' label='Username' name='username' onChange={inputHandler} fullWidth/>
    <br /><br />
    <TextField variant='outlined' label='Email' name='email' onChange={inputHandler} fullWidth/>
    <br /><br />
    <TextField variant='outlined' label='Exit Mark' name='exitmark' onChange={inputHandler} fullWidth/>
    <br /><br />
     <TextField variant='outlined' label='Password' name='password' type='password' onChange={inputHandler} fullWidth/>
    <br /><br />
    <TextField variant='outlined' label='Confirm Password' name='confirmpassword' type='password' onChange={inputHandler} fullWidth/>
    <br /><br />
