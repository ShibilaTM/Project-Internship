...
import Newnavbar from '../../utilities/Newnavbar';
...
const Internshipdynamicpage = (props) => {
    ...
    const Handleconfirmbuttonclick = async () => {
        ...
        // await postisinternshipselected()
    ...
    return (
        <div>
            ...
            <div className='containeroftheInternshippage'>
                ...
                <Grid container spacing={2} style={{ width: "1150px", }}>
                    <Grid >
                        <h1 className='h1promax'>     {props.heading}</h1>

                        <img src={props.image} className='ImageoftheIntershippage' style={{ height: "350px", width: "500px" }} alt="" />
                ...
                <Grid container spacing={2} style={{ width: "1130px", marginLeft: "95px" }}>
                    <Grid item xs={6}>
                        <button className='BackbuttonoftheIntershippage' style={{ background: "white", color: "black", borderRadius: "10px" }} onClick={HandleBackButtonclick}>Back</button>

                    </Grid>
                    <Grid item xs={6}>

                        <button className='buttonoftheIntershippage' style={{ width: "280px", background: "white", color: "black", borderRadius: "10px" }} onClick={Handleconfirmbuttonclick} >Click Here to Confirm your Intership</button>
                    </Grid>
