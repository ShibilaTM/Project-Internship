...
//     const userEmail = localStorage.getItem('userEmail');
//     // Check user submission status when the component mounts
...
//     // Use a server-side endpoint to check the user's submission status
//     axiosInstance.get(`http://127.0.0.1:4000/form/submission-status?userEmail=${userEmail}`)
//       .then((res) => {
...
//     // if (project.title.trim() === '' || project.url.trim() === '' ||project.projectreport.trim()==='' ||project.comments.trim() === '') {
...
//     // Use a server-side endpoint to submit the project
//     axiosInstance.post('http://127.0.0.1:4000/form/project', projectData).then((res) => {
//       alert(res.data.message);
//       setAlreadySubmitted(true);
//       // Save in local storage to persist the information across browser sessions (if needed)
//       localStorage.setItem(`submitted_${userEmail}`, 'true');
//     });
//   };
